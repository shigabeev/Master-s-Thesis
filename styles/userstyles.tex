...
\newenvironment{conditions}
  {\par\vspace{\abovedisplayskip}\indent\begin{tabular}{>{$}l<{$} @{${} - {}$} l}}
  {\end{tabular}\par\vspace{\belowdisplayskip}}

%% значения в таблицах по центру в tabularx
\newcolumntype{Y}{>{\centering\arraybackslash}X}


% Оглавление размером 16
\renewcommand\cftchapfont{16pt, \bfseries}
